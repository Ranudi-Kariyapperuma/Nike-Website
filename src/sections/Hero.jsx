  ...
  return (
    ...
    >
     ...
     justify-center items-start w-full max-xl:padding-x pt-28 ">
      ...
      <p className="text-xl font-montserrat text-purple-950 font-medium">Our Summer Collection</p>
      <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px]
      max-sm:leading[82] font-bold">
        <span className="xl:bg-violet-50 xl:whitespace-nowrap relative z-10 pr-10">
        Where Stylish with
        </span>
        <br />
        <span className="text-fuchsia-500 inline-block mt-3">Lily</span> Clothes
      </h1>
